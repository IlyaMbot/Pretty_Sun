...
#        self.srhFits.changeNorthPhase(self.nLcpPhaseCorrection, self.nRcpPhaseCorrection)
    ...
    def onEastWestLcpPhaseSlopeChanged(self, value):
        ...
        self.srhFits.buildEwPhase(self.ewLcpPhaseSlope[self.currentFrequencyChannel], self.ewRcpPhaseSlope[self.currentFrequencyChannel])
        if (self.imageUpdate):
            self.buildImage()
            self.showImage()
    ...
    def onNorthLcpPhaseSlopeChanged(self, value):
        self.nLcpPhaseSlope[self.currentFrequencyChannel] = value
        self.srhFits.buildNPhase(self.nLcpPhaseSlope[self.currentFrequencyChannel], self.nRcpPhaseSlope[self.currentFrequencyChannel])
        if (self.imageUpdate):
            self.buildImage()
            self.showImage()

    def onNorthRcpPhaseSlopeChanged(self, value):
        self.nRcpPhaseSlope[self.currentFrequencyChannel] = value
        self.srhFits.buildNPhase(self.nLcpPhaseSlope[self.currentFrequencyChannel], self.nRcpPhaseSlope[self.currentFrequencyChannel])
        if (self.imageUpdate):
            self.buildImage()
            self.showImage()
    ...
    def onCenterDisk(self):
        ...
        self.ewLcpPhaseSlopeSpin.setValue(self.srhFits.ewSlopeLcp)
        self.nLcpPhaseSlopeSpin.setValue(self.srhFits.nSlopeLcp)
        self.ewRcpPhaseSlopeSpin.setValue(self.srhFits.ewSlopeRcp)
        self.nRcpPhaseSlopeSpin.setValue(self.srhFits.nSlopeRcp)
    ...
    def onFrequencyChannelChanged(self, value):
        ...
        self.nLcpPhaseSlopeSpin.setValue(self.nLcpPhaseSlope[self.currentFrequencyChannel])
        self.nRcpPhaseSlopeSpin.setValue(self.nRcpPhaseSlope[self.currentFrequencyChannel])
...
#        self.casaWidget.layout.addWidget(self.casaRightCanvas,5,1)
        ...
        self.tab2.layout.addWidget(self.calculatePhaseAllButton, 1, 5)
